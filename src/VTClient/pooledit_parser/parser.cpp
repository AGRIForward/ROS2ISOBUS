...
int getRealSize(void *object) {
    ...
    // Legacy AuxiliaryFunction (type 29) is still supported for size accounting.
    case 29:
        {
    ...
    // AUX-N AuxiliaryFunction2 (type 31).
    case 31:
        {
...
void addObjectReference(void **object, ObjectReference objectReference, int role)
{
    ...
    if (role == ROLE_NONE) {
        ...
        case 30:
            ...
            break;
        // AUX-N AuxiliaryFunction2 can contain include_object references like legacy AUX.
        case 31:
    ...
    case 25: // FillAttributes
        {
            ...
            // ISO 11783-6:2018 Table B.50:
            // Fill pattern NULL value shall be 65535 when not used.
            fillAttributes->fillPattern = 65535;
    ...
    case 31:
        {
            ...
            // XML tag stays <auxiliaryfunction>, but encoder emits AUX-N object type 31.
            auxiliaryFunction2->type = 31;
            auxiliaryFunction2->backgroundColor = getBackgroundColor(attr, vtColors);
            // ISO 11783-6:2018 Table J.2 byte 5 (function attributes).
            // Defaults for bits 5..7 are false (0), so only type bits are set here.
            auxiliaryFunction2->functionAttributes = getFunctionType(attr);
