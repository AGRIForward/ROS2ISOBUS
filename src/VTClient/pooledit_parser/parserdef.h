...
// AUX-N function object (ISO 11783-6:2018 Table J.2, object type 31)
// functionAttributes bitfield:
//  bits 0..4 = function type (boolean non-latching = 2, analogue = 1)
//  bit 5 = critical control
//  bit 6 = assignment restriction
